...
# iwnlp
echo "downloading model for IWNLP..."
...
# clevertagger
echo "downloading clevertagger deps..."
...
# treetagger
echo "downloading treetagger..."
mkdir treetagger
wget -qO - https://cis.uni-muenchen.de/~schmid/tools/TreeTagger/data/tree-tagger-linux-3.2.2.tar.gz | tar xz --directory treetagger
wget -qO - https://cis.uni-muenchen.de/~schmid/tools/TreeTagger/data/tagger-scripts.tar.gz | tar xz --directory treetagger
